...
public partial class ProductListView : ContentView
{
    ...
    public static readonly BindableProperty TitleProperty = BindableProperty.Create(nameof(Title), typeof(string),
        typeof(ProductListView), string.Empty, BindingMode.TwoWay);
    ...
    public static readonly BindableProperty OrginalPriceProperty = BindableProperty.Create(nameof(OrginalPrice), typeof(double),
        typeof(ProductListView), 0.00, BindingMode.TwoWay);
    ...
    #region Commands
    public static readonly BindableProperty ProductTappedCommandProperty = BindableProperty.Create(nameof(ProductTappedCommand), typeof(DelegateCommand<Product>), typeof(ProductListView), null);
